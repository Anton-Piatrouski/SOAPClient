...
public class CustomerServiceImplServiceLocator extends org.apache.axis.client.Service implements by.epam.service.impl.CustomerServiceImplService {
    ...
    private java.lang.String CustomerServiceImplPort_address = "http://localhost:8080/SOAP/customers";
    ...
    public by.epam.service.CustomerService getCustomerServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public by.epam.service.CustomerService getCustomerServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            by.epam.service.impl.CustomerServiceImplPortBindingStub _stub = new by.epam.service.impl.CustomerServiceImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (by.epam.service.CustomerService.class.isAssignableFrom(serviceEndpointInterface)) {
                by.epam.service.impl.CustomerServiceImplPortBindingStub _stub = new by.epam.service.impl.CustomerServiceImplPortBindingStub(new java.net.URL(CustomerServiceImplPort_address), this);
                _stub.setPortName(getCustomerServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.service.epam.by/", "CustomerServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.service.epam.by/", "CustomerServiceImplPort"));
        }
